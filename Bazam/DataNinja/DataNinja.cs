...
namespace Bazam.DataNinja
{
    public class DataNinja
    {
        ...
        public DataNinja(string serverName, string databaseName) : this(serverName, databaseName, string.Empty, string.Empty)
        {
            UseWindowsAuthentication = true;
        }

        public DataNinja(string serverName, string databaseName, string userName, string password)
        {
