...
namespace BazamTests
{
    ...
    public class DataNinjaTest
    {
        ...
        private static DataNinja myNinja;
        private static DataNinja myWindowsAuthenticationNinja;
        ...
        {
            myNinja = new DataNinja("TestServer\\SQL2005", "Bazam", "import.admin", "in2258biz");
            myWindowsAuthenticationNinja = new DataNinja("SQLServ1\\SQL2008", "DEV_2010SR1_RP10");
        }
